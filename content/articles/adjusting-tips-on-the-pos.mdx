...
2. Go to the order that has a tip that needs to be adjusted. Step 3: Tap the icon and select Adjust tip.
3. On the Adjust amount window, enter the correct tip amount. Then, click Done to update the tip.
